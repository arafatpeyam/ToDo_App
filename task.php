...
// create a function to load task
...
// create a function to save taskes to the json
...
// checking  submitted  POST reques from form
            ...
            <ul style="list-style: none; padding: 0;">
                <?php if (empty($tasks)): ?>
                    <li>No tasks yet. Add one above!</li>
                     <!-- display all task if task are available into tasks.json file  -->
                <?php else: ?>
